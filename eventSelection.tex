...
\begin{figure}[h!t]
  \begin{center}
      ...
      \caption{\label{fig:ht} $\scalht$ distribution after basic preselection,
           ...
           and two SUSY signal samples, from~\cite{RA1Paper}. This figure is for 
           illustrative purposes only, as these specific SUSY models are not under 
...
describe the identification of objects in the hadronic and control samples, while the 
detail description of the background and control samples are left for chapter~\ref{sec:background}.
