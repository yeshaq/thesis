...
\scalht, the scalar sum of the transverse energy of the jets in the event, 
to quantify the energy in an event. The challenges due to large
...
\begin{figure}[h!t]
  \begin{center}
    ...
    \caption{HT distribution from~\cite{RA1Paper} }
