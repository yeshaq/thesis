...
$\njethigh$.  Each event in these categories is further categorized by the number
...
ECAL cells within $\Delta R \left(\vecp_{j},\rm{cell}\right) < 0.3$ is counted. If the number exceeds 
