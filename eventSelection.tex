...
from balanced multi-jet QCD events. Furthermore, QCD events with mismeasured jets are
largly rejected since they fall below the \alphat threshold.  However, 
two types of rare backgrounds from multi-jet events can lead to values of \alphat 
greater than 0.55. The first is rare circumstance in which several jets with similar 
values of the azymuthal angle ($\phi$) fail to pass the jet \pt threshold. 
...
that are absorbed by inneficient crystals in the ECAL. These crystals, 
