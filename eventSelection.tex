...
of jets identified as orginating from b quarks ($\nb$). Events having 
...
Furhtermore, events with back-to-back mismeasured jets are also rejectd. Nonetheless
...
not be considered in the caclculation of \scalht and as a result, they would bias the 
...
``fake'' \mht in the event. As a filther, the quantaty:
