...
The p-values obtained, shown in Figure~\ref{fig:fluct} (Left), are found 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[p-values per event category.]{
      \includegraphics[width=0.45\textwidth, trim=0 190 290 20, clip=true]{figures/fit/v22/pValues} % lbrt
    } 
    \subfigure[Pull versus signal region bin.\label{fig:sigVsCat}]{
      \includegraphics[width=0.45\textwidth, trim=0 0 0 30, clip=true]{figures/fit/v22/significances_catVsHt}
    } \\
