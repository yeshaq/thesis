...
the signal term is removed from the likelihood model. The parameters 
maximizing the likeliood are summarized in Ref:Table. The uncertainty on 
these parameters are obtained by constrcting a probablity density
function (p.d.f) from the maximized likelihood, then generating 
ensemble of peudo-experiments from this p.d.f. and maxmizing the same 
likelihood form for each pseudo-experiment, resulting in an esemble of parameters.
