...
\begin{center}
\includegraphics[width=.5\paperwidth,]{../figures/Figures_T_Coordinate.png}
\end{center}

Known and conserved quantities: 
\begin{itemize}
\item transverse momentum, $\pt \equiv P \sin\left(\theta\right)$, ,
\item transverse energy, $E_{T} \equiv E \sin\left(\theta\right)$, 
\end{itemize}
...
{
\usebackgroundtemplate{{\transparent{0.3}\includegraphics[width=\paperwidth,height=\paperheight]{../figures/met_schematic.png}}}
\frame{
\color{black}
...
\begin{itemize}
\item $\alphat < 0.55 \rightarrow \alphat > 0.55$:  *mj sample test
\item $\nb = 0 \rightarrow \nb = 1$:  *mj sample test
s\item $\nb = 0 \rightarrow \nb = 1$:  *mj sample test
\end{itemize}
an example:
