...
\hline
2b le3j SM Hadronic\T   & $58.0^{+3.1}_{-2.5}$           & $17.8^{+1.5}_{-1.3}$           & $4.0^{+0.6}_{-0.5}$            & $1.0^{+0.2}_{-0.2}$            & $0.2^{+0.1}_{-0.1}$            & $0.0^{+0.0}_{-0.0}$            & $0.0^{+0.0}_{-0.0}$            & $0.0^{+0.0}_{-0.0}$            \\ 
...
\scalht Bin (GeV)       & 375--475                       & 475--575                       & 575--675                       & 675--775                       & 775--875                       & 875--975                       & 975--1075                      & 1075--$\infty$                 \\ [1.000000ex]
\hline
2b le3j SM $\mu$+jets\T & $668^{+26}_{-23}$              & $217^{+16}_{-13}$              & $75.0^{+10.1}_{-8.1}$          & $18.0^{+4.8}_{-4.0}$           & $15.0^{+3.9}_{-3.8}$           & $5.0^{+2.0}_{-2.0}$            & $2.0^{+1.0}_{-1.9}$            & $1.0^{+1.0}_{-1.0}$            \\ 
