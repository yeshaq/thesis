...
\begin{figure}[h!]
  \begin{center}
    \subfigure[\njethigh, $\nb = 1$.]{
     \includegraphics[width=0.48\textwidth,page=6]{figures/sms/t2tt/v1/t2tt_pfJet_totalUnc.pdf}
    }
    \subfigure[\njethigh, $\nb = 2$.]{
     \includegraphics[width=0.48\textwidth,page=7]{figures/sms/t2tt/v1/t2tt_pfJet_totalUnc.pdf}
    }\\       
