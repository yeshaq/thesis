...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[11pt,letter,twoside,psfig,epsfig,titlepage]{report}
...
\author{Yossof Eshaq\vspace{4mm}\\
  %\scalebox{0.3}{\includegraphics{belle.eps}} \vspace{5.0mm} \\
  {\sl Submitted in Partial Fulfillment of the }\\
  {\sl Requirements for the Degree}
  {\sl Doctor of Philosophy}\\[2cm]
  Supervised by Professor Aran Garcia-Bellido\\[2cm]
  Department of Physics & Astronomy\\
  Arts, Sciences and Engineering\\
  University of Rocheser\\[1cm]
}
  
%\date{\textcolor{red}{Version 3\\ Oct. 30, 2008}}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\input{app_naive}
%%\input{app_fit}
%\input{results_plots_a_priori_two_sigma_bands}
%\input{fits_with_signal}
%%\input{app_cross_checks}
