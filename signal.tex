...
%squark) and daughter sparticle masses, which are used to illustrate
%potential yields in the signal region. The masses are chosen to be
%reasonably high while still being excluded according to
%expectation. 
...
%    \texttt{T2Degen} & \Ttwodegen            & (2--3,0), (2--3,1), ($\geq 4$,0), ($\geq 4$,1) \\
    \hline
    \hline
  \end{tabular}
\end{table}
