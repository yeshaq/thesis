...
In \verb!T2cc!, the efficiencies are typically at the percent level or less due to
...
negligible with respect to the signal region. Regardless, any 
potential contamination is accounted for in the likelihood model.
...
%\subsection{Additional systematics uncertainty on signal efficiency\label{sec:sms-syst-add}}
%
%Three additional systematic uncertainties are added in quadrature to the 
%measured uncertatines described above. The uncertainty in the luminosity
%measurment (2.6\%), the trigger uncertainty (5\%) and the uncertainty in the 
%'''dead ecal''' filter (3\%) described in [REF] total 4.1\%  
%
