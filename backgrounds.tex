...
%
\wj and \ttbar processes are found in the hadronic signal region when 
the decay lepton isn't reconstructed or falls out of acceptance.  
Additionally, a tau lepton from a high-p$_{T}$ W boson can decay
into quarks.  An estimate of these background processes is
obtained through the use of a \mj sample. A selection criteria
is chosen to identify W bosons decaying to a muon and a
...
\alphat as to mimic a loss of a lepton in the hadronic signal region.
All cuts on such jet-based quantities are consistent with
