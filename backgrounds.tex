...
compared. Lastly, while all other jet-based quantaties, like \scalht 
...
that no signficant biases is seen from the exclusion of the \alphat cut.
...
consistant with the hadronic search region including the $\alphat > 0.55$ cut.
