...
\indent For a particular production process, e.g. $pp \ra \ttbar$ or $pp \ra \tilde{g}\tilde{g}$, there are 
...
to measure muons with great precision; with the ability to resolve a muon's momentum in the 
transverse plane down to 1\% in some cases. Its last name refers to to the superconducting solenoid of diameter 
