...
Figure~\ref{fig:upperLimits-t2cc} shows the observed upper 
limit for each sparticle mass pair for the SMS model where a stop particle 
decays to a charm quark and a neutralino (\texttt{T2cc}). 
The black curve represents the 

provided The thick black curve represents the 
observed upper limit 
observed limit The expected upper limit
